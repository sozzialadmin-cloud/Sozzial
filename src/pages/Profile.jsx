    ...
    <div className="min-h-[calc(100vh-64px)] bg-[#060606] px-3 py-3 pb-[calc(var(--mobile-nav-height)+1.25rem)] text-white sm:px-4 sm:pb-6">
      <div className="mx-auto grid max-w-5xl gap-4">
        ...
        <section className="rounded-[24px] border border-white/10 bg-[#101010] p-3 shadow-[0_18px_46px_rgba(0,0,0,0.28)] sm:p-4">
          <div className="grid grid-cols-2 gap-1 rounded-[18px] border border-white/10 bg-black/25 p-1 sm:grid-cols-4">
            {[
          ...
          {activeSection === 'profile' ? (
            <div className="mt-4">
              <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Link to={`/profile/${user.id}`} className="inline-flex h-10 w-full items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] px-3 text-xs font-black text-white hover:bg-white/[0.07] sm:w-auto">
                  <UserRound className="mr-2 h-4 w-4" />
                  View public
                </Link>
              </div>
              <div className="grid min-w-0 grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  ...
                  <Input value={form.username} onChange={(e) => setForm((prev) => ({ ...prev, username: e.target.value }))} className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
                <div>
                  <Label className="mb-2 block text-xs font-bold uppercase tracking-[0.14em] text-stone-500">City</Label>
                  <Input value={form.city} onChange={(e) => setForm((prev) => ({ ...prev, city: e.target.value }))} className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
                <div>
                  <Label className="mb-2 block text-xs font-bold uppercase tracking-[0.14em] text-stone-500">Neighborhood</Label>
                  <Input value={form.neighborhood} onChange={(e) => setForm((prev) => ({ ...prev, neighborhood: e.target.value }))} className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
                <div>
                  <Label className="mb-2 block text-xs font-bold uppercase tracking-[0.14em] text-stone-500">Favorite slice</Label>
                  <Input value={form.favorite_slice} onChange={(e) => setForm((prev) => ({ ...prev, favorite_slice: e.target.value }))} placeholder="Pepperoni, grandma, margherita..." className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
                <div>
                  <Label className="mb-2 block text-xs font-bold uppercase tracking-[0.14em] text-stone-500">Pizza style</Label>
                  <Input value={form.pizza_style} onChange={(e) => setForm((prev) => ({ ...prev, pizza_style: e.target.value }))} placeholder="Cheap slices, classics, date-night spots..." className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
                <div>
                  <Label className="mb-2 block text-xs font-bold uppercase tracking-[0.14em] text-stone-500">Dietary notes</Label>
                  <Input value={form.dietary_notes} onChange={(e) => setForm((prev) => ({ ...prev, dietary_notes: e.target.value }))} placeholder="Vegetarian, halal, gluten-free..." className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
                <div className="sm:col-span-2">
                  ...
                  <div className="rounded-[18px] border border-white/10 bg-white/[0.04] p-2">
                    <Input
                      ...
                      className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-[#171717] text-white"
                    />
                ...
                <div className="sm:col-span-2">
                  ...
                  <Textarea value={form.bio} onChange={(e) => setForm((prev) => ({ ...prev, bio: e.target.value }))} className="min-h-[110px] w-full min-w-0 resize-none rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
                <div>
                  <Label className="mb-2 block text-xs font-bold uppercase tracking-[0.14em] text-stone-500">Instagram URL</Label>
                  <Input value={form.instagram_url} onChange={(e) => setForm((prev) => ({ ...prev, instagram_url: e.target.value }))} className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
                <div>
                  <Label className="mb-2 block text-xs font-bold uppercase tracking-[0.14em] text-stone-500">Website URL</Label>
                  <Input value={form.website_url} onChange={(e) => setForm((prev) => ({ ...prev, website_url: e.target.value }))} className="h-11 w-full min-w-0 rounded-2xl border-white/10 bg-white/[0.04] text-white" />
                </div>
              </div>
              <Button disabled={saveProfile.isPending} onClick={() => saveProfile.mutate()} className="mt-5 h-11 w-full rounded-2xl bg-[#efbf3a] px-5 font-black text-[#141414] hover:bg-[#dbab23] sm:w-auto">
                Save profile
              </Button>
            </div>
          ) : null}
