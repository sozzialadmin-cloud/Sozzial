  ...
  return (
    <AnimatePresence>
      ...
      <motion.div
        ...
        className="fixed left-3 right-3 top-[calc(var(--header-height)+0.75rem)] bottom-[calc(var(--mobile-nav-height)+0.75rem)] overflow-y-auto sm:bottom-auto sm:left-1/2 sm:right-auto sm:top-1/2 sm:max-h-[calc(100dvh-var(--header-height)-2rem)] sm:w-[380px] sm:-translate-x-1/2 sm:-translate-y-1/2"
