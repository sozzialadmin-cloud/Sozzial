...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="app-shell">
      ...
      <main className={`${hideHeader ? 'page-transition' : `app-content page-transition ${VIEWPORT_PAGE_NAMES.has(currentPageName) ? 'app-content--viewport' : 'app-content--standard'} ${hideBottomNav ? 'app-content--flush' : ''}`}`}>
        {children}
      </main>
